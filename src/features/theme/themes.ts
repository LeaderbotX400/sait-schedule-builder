/**
 * Static theme metadata — use this to render theme-picker swatches and
 * labels. The `id` values correspond to `[data-theme="<id>"]` selectors
 * in `src/index.css`.
 */

import type { ThemeId, ThemeMode } from "./store";
